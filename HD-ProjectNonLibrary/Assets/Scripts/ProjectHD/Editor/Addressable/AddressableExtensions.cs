namespace ProjectHD.Editor
{
    ...
    public static class AddressableExtensions
    {
        ...
        public static void SetAddressable(Object obj)
        {
            ...
            var entry = obj.GetAddressableAssetEntry();
        ...
        public static void SetAddressableAssetLabel(this Object source, string label)
        {
            if (source == null || !AssetDatabase.Contains(source))
                return;
        ...
        public static void SetAddressableAssetGroup(this Object source, AddressableAssetGroup group)
        {
            ...
            if (entry != null && !source.IsInAddressableAssetGroup(group.Name)) {
                ...
                AddressableAssetSettingsDefaultObject.Settings.SetDirty(AddressableAssetSettings.ModificationEvent.GroupMoved, entry, true);
            }
        }
        ...
        public static bool CheckIsAddressable(Object source)
        {
            var sourcePath = AssetDatabase.GetAssetPath(source);
            var sourceGuid = AssetDatabase.AssetPathToGUID(sourcePath);
            return AddressableAssetSettingsDefaultObject.Settings.FindAssetEntry(sourceGuid) != null;
        }
    }
}