...
namespace Utilities
{
    public static class InternalDebug
    {
        ...
        {
            LogString("[LOG_Build] " + message, ProjectEnum.LogType.LOG_Build);
        }
        
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        public static void LogErrorBuild(string message)
        {
            LogErrorString("[LOG_Build] " + message, ProjectEnum.LogType.LOG_Build);
        }
        
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        public static void LogBattle(string message)
        {
            LogString("[LOG_Battle] " + message, ProjectEnum.LogType.Log_UI);
        }
        
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        public static void LogUI(string message)
        {
            LogString("[LOG_UI] " + message, ProjectEnum.LogType.Log_UI);
        }
        
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        public static void LogNetwork(string message)
        {
            LogString("[Log_Network]" + message, ProjectEnum.LogType.Log_Network);
        }
        
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        public static void LogSound(string message)
        {
            LogString("[LOG_Sound] " + message, ProjectEnum.LogType.Log_Sound);
        }
        
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        public static void LogCore(string message)
        {
            LogString("[LOG_Core] " + message, ProjectEnum.LogType.Log_Core);
        }
        
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        private static void LogString(string message, ProjectEnum.LogType logType)
        {
            if (!StaticMethod.IsFlagSet(logFrag, (long)logType))
            {
        ...
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        private static void LogErrorString(string message, ProjectEnum.LogType logType)
        {
            if (!StaticMethod.IsFlagSet(logFrag, (long)logType))
            {
        ...
        [Conditional("DEVELOPMENT_BUILD"), Conditional("UNITY_EDITOR")]
        public static void Log(object message, ProjectEnum.LogType logType)
        {
            if (!StaticMethod.IsFlagSet(logFrag, (long)logType))
            {
                UnityEngine.Debug.Log(message);
